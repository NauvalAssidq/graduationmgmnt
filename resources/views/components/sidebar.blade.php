<aside class="w-64 bg-emerald-800 border-r border-emerald-700 flex-shrink-0 fixed h-full z-10 hidden lg:block">
    ...
    <nav class="p-4 space-y-1">
        ...
        <a href="{{ route('settings.index') }}" class="flex items-center gap-3 px-3 py-2.5 {{ request()->routeIs('settings.*') ? 'bg-emerald-900 text-white' : 'text-emerald-100 hover:text-white hover:bg-emerald-700' }} text-sm font-medium rounded-md transition-colors">
