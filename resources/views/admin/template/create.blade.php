...
@section('content')
        <x-breadcrumb :items="['Kelola Template' => route('template.index'), 'Tambah Template' => null]" />

        <div class="mb-6">
            <h1 class="text-2xl font-bold text-slate-800">Tambah Template Baru</h1>
            <p class="text-slate-500 text-sm mt-1">Konfigurasi layout dan format buku wisuda.</p>
        </div>
            ...
            <form action="{{ route('template.store') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" class="w-full p-2.5 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('nama') }}" placeholder="Contoh: standard_v1" required>
                        <p class="text-xs text-slate-400 mt-1">Gunakan nama unik tanpa spasi (snake_case).</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="style" id="style" class="w-full p-2.5 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('style', 'default') }}" placeholder="Contoh: modern-theme" required>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <p class="text-xs text-slate-500 mb-2">Masukkan HTML untuk Cover, Pengantar, dan Daftar Isi. Gunakan class <code>.a4-page</code> untuk setiap halaman baru.</p>
                        <x-code-editor 
                            name="cover_html" 
                            label="Cover & Front Matter HTML" 
                            :value="old('cover_html')" 
                            mode="htmlmixed" 
                            height="400px" 
                        />
                ...
                <div class="pt-6 border-t border-gray-100 flex items-center justify-end gap-3">
                    ...
                    <button type="submit" class="px-4 py-2 bg-emerald-700 hover:bg-emerald-800 text-white rounded-lg text-sm font-medium transition-colors shadow-sm">Simpan Template</button>
                </div>
            </form>
        </div>
