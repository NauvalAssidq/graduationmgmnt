                        ...
                        @forelse($archives as $book)
                            <tr class="bg-white hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    ...
                                    <a href="{{ route('admin.arsip.preview', $book->buku_wisuda_id) }}" target="_blank" 
                                    ...
                                    <form action="{{ route('admin.arsip.generate', $book->buku_wisuda_id) }}" method="POST" class="inline-block">
                                        @csrf
                                        @if($book->file_pdf)
