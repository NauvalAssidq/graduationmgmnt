            ...
            <form action="{{ route('buku-wisuda.update', $bukuWisuda) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="tahun_akademik" id="tahun_akademik" class="w-full p-2.5 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('tahun_akademik', $bukuWisuda->tahun_akademik) }}" placeholder="Contoh: 2025/2026">
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_sk" id="nomor_sk" class="w-full p-2.5 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('nomor_sk', $bukuWisuda->nomor_sk) }}" placeholder="Contoh: B-087/Un.08/R/PP.00.9/03/2026">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_sk" id="tanggal_sk" class="w-full p-2.5 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('tanggal_sk', $bukuWisuda->tanggal_sk) }}">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_rektor" id="nama_rektor" class="w-full p-2.5 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('nama_rektor', $bukuWisuda->nama_rektor) }}" placeholder="Contoh: Prof. Dr. H. Mujiburrahman, M.Ag">
                    ...
                    <div>
                        ...
                        <input type="text" name="nip_rektor" id="nip_rektor" class="w-full p-2.5 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('nip_rektor', $bukuWisuda->nip_rektor) }}" placeholder="Contoh: 19710908 199903 1 004">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="sambutan_rektor" id="sambutan_rektor" rows="12" class="w-full p-2.5 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" placeholder="Masukkan isi sambutan rektor di sini.">{{ old('sambutan_rektor', $bukuWisuda->sambutan_rektor) }}</textarea>
