...
@section('header', 'Edit Wisudawan')

@section('content')
        <x-breadcrumb :items="['Kelola Wisudawan' => route('wisudawan.index'), 'Edit Data' => null]" />

        <div class="mb-6">
            <h1 class="text-2xl font-bold text-slate-800">Edit Data Wisudawan</h1>
            <p class="text-slate-500 text-sm mt-1">Perbarui informasi data wisudawan.</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-300 p-6">
            <form action="{{ route('wisudawan.update', $wisudawan->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama" id="nama" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('nama', $wisudawan->nama) }}" required>
                            @error('nama') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                        </div>

                        <div>
                            <label for="nim" class="block text-sm font-medium text-slate-700 mb-1">NIM</label>
                            <input type="text" name="nim" id="nim" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('nim', $wisudawan->nim) }}" required>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="ttl" id="ttl" placeholder="Banda Aceh, 10-10-2000" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('ttl', $wisudawan->ttl) }}" required>
                            ...
                            <div>
                                ...
                                <x-select 
                                    ...
                                    :value="old('jenis_kelamin', $wisudawan->jenis_kelamin)" 
                        ...
                        <div>
                            ...
                            @if($wisudawan->foto)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($wisudawan->foto) }}" alt="Current Foto" class="h-20 w-20 object-cover rounded-md border border-gray-300">
                                </div>
                            @endif
                            ...
                            <p class="text-xs text-slate-400 mt-1">Kosongkan jika tidak ingin mengubah foto. Format: JPG, PNG. Max: 2MB.</p>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="fakultas" id="fakultas" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('fakultas', $wisudawan->fakultas) }}" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="prodi" id="prodi" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('prodi', $wisudawan->prodi) }}" required>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="nomor" id="nomor" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('nomor', $wisudawan->nomor) }}" required>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" max="4.00" name="ipk" id="ipk" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('ipk', $wisudawan->ipk) }}" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="ka_yudisium" id="ka_yudisium" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" value="{{ old('ka_yudisium', $wisudawan->ka_yudisium) }}" required>
                        ...
                        <div>
                            ...
                            <textarea name="judul_thesis" id="judul_thesis" rows="3" class="w-full p-2 rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 text-sm" required>{{ old('judul_thesis', $wisudawan->judul_thesis) }}</textarea>
                ...
                <div class="pt-6 border-t border-gray-100 flex items-center justify-end gap-3">
                    ...
                    <button type="submit" class="px-4 py-2 bg-emerald-700 hover:bg-emerald-800 text-white rounded-lg text-sm font-medium transition-colors shadow-sm">Perbarui Data</button>
                </div>
            </form>
    </div>
@endsection
